...
dayList <- c(20:30)                          # put the days of the month here, without caring about short months
monthList <- c(10)                      # months go here
yearList <- c(2013)                    # years
dayblocks <- list(c(20:22), c(22:24), c(24:26), c(26:28), c(28:30))       # Set the blocks of days you want to run together to plot in the same map
...
pdf("./Guiana_winds_20-30_two-day.pdf")
for (n in coord){
  for (i in monthList){
    for (j in dayblocks){
