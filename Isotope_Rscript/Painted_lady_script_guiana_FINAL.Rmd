...
drive_download(mean_file, path= "isoscapes/raw/Sr_Bataille2020_mean.tif")
sd_file <-  drive_get(as_id("1MfEU8-TQkvUokCqFFNv355_cuZUB8mpw"))
drive_download(sd_file, path= "isoscapes/raw/Sr_Bataille2020_sd.tif")
```

```{r eval=FALSE, warning=FALSE}
rf_sr<-raster("isoscapes/raw/Sr_Bataille2020_mean.tif")
rf_sr_err <-raster("isoscapes/raw/Sr_Bataille2020_sd.tif")
...
Make isoscape:
```{r eval=FALSE}
d2H_wing<-calRaster(known=caldata, isoscape=d2h_world, interpMethod = 2, outDir="isoscapes/final")
```
```{r}
#add ref scale
...
ggsave(plot=iso_plot, filename="isoscapes/final/isoscapes.pdf", height=10, width=14, units="in")
ggsave(plot=iso_plot, filename="isoscapes/final/isoscapes.png", height=6, width=8, units="in")
```
# fin
```{r}
sessionInfo()
